...
Monitors [SwiftQueue Wigan](https://www.swiftqueue.co.uk/wigan.php) for blood test slots and sends a Telegram alert the moment one appears before your target date. Runs in Docker — no Python setup required.
